...
<div class="col-md-6">
<h4><storng>Accountant</storng> </h4>
</div>
</div>
<!-- <img src="" alt=""> -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header" style="background:linear-gradient(90deg, #000046 0%,#1cb5e0 100% );">
        <h5 class="modal-title" id="exampleModalLabel" style="color: white;"> Update Accountant</h5>
      ...
      <form action="../../../controler/controller.php?id=<?=$row['employee_id']?>" method="post" enctype="multipart/form-data">
        ...
        <input type="text" class="form-control" value="<?php echo $edit_row['employee_name']; ?>" name="employee_name" placeholder="Enter Accountant Name ">
        </div>
        <div class="form-group">
        <label for="Email">Email</label>
        <input type="text" class="form-control" value="<?php echo $edit_row['employee_email']; ?>" name="employee_email" placeholder="Enter Accountant Email ">
        </div>
        <div class="form-group">
        <label for="Phone">Phone</label>
        <input type="text" class="form-control" value="<?php echo $edit_row['employee_phone']; ?>" name="employee_phone" placeholder="Enter Accountant Phone ">
        </div>
        <div class="form-group">
        ...
        <input type="password" class="form-control" value="<?php echo $edit_row['employee_password']; ?>" name="employee_password" placeholder="Enter Accountant Password ">
        </div>
        <div class="form-group">

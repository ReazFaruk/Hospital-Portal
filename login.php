...
if(isset($_POST["login"]))
{
    ...
    $query = $DB_con->query("SELECT * FROM users WHERE email = '$email' AND password =  '$password' ");
...
<form method="post">
    <div class="row">
        <div class="col-md-6 mx-auto rounded p-6" style="background-color: #ECFAFD ;">
            ...
            <div class="d-flex justify-content-center">
                <a href="admin/index.php" style="text-decoration: none;"><hr>staff login here..</a>
            </div>
            <br>
            <br>
        </div>
...
<br>
<div class="d-flex justify-content-center">
    <a href="#">For Emergency cabin Booking, click here...</a>
</div>